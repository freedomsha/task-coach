...
class AbstractNtlmAuthHandler:
    ...
    def http_error_authentication_required(
        self, auth_header_field, req, fp, headers
    ):
    ...
    def retry_using_http_NTLM_auth(
        self, req, auth_header_field, realm, headers
    ):
        ...
        if pw is not None:
            ...
            (ServerChallenge, NegotiateFlags) = (
                ntlm.parse_NTLM_CHALLENGE_MESSAGE(
                    base64.decodestring(auth_header_value[5:])
                )
            )
